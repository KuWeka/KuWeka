...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:3b0764,40:6d28d9,80:9b30ff,100:c084fc&height=230&section=header&text=Eka%20Ridhoni%20August%20Firmansyah&fontSize=48&fontColor=ffffff&fontAlignY=42&desc=Full-Stack%20Dev%20%E2%80%A2%20Network%20Eng%20%E2%80%A2%20IoT%20Builder&descColor=e9d5ff&descSize=16&descAlignY=63&animation=twinkling" width="100%"/>

<br/>

<!-- Typing SVG -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=20&duration=2600&pause=800&color=9B30FF&center=true&vCenter=true&width=750&lines=Hi+there!+I'm+Eka+Ridhoni+August+Firmansyah+%F0%9F%91%8B;Full-Stack+Developer+%40+Polda+Kalimantan+Selatan+%F0%9F%9B%A1%EF%B8%8F;React+%C2%B7+Node.js+%C2%B7+MySQL+%C2%B7+Redis+%C2%B7+Docker;Network+Engineer+%7C+IoT+%7C+Mikrotik;Building+systems+that+actually+work+%F0%9F%9A%80)](https://git.io/typing-svg)

<br/>

<!-- Static Badges -->
![Purple Dev](https://img.shields.io/badge/%F0%9F%92%BB_Full--Stack_Developer-6D28D9?style=for-the-badge)
![Network Eng](https://img.shields.io/badge/%F0%9F%94%97_Network_Engineer-7C3AED?style=for-the-badge)
![IoT Builder](https://img.shields.io/badge/%F0%9F%8C%B1_IoT_Builder-9B30FF?style=for-the-badge)

<br/>

<!-- Open to Collaborate -->
[![Open to Collaborate](https://img.shields.io/badge/%F0%9F%A4%9D_Open_to_Collaborate-22C55E?style=for-the-badge)](mailto:ekaridhoni1202@gmail.com)
...
![Location](https://img.shields.io/badge/%F0%9F%93%8D_Banjarbaru,_Kalimantan_Selatan-Indonesia-7C3AED?style=flat-square)
![Education](https://img.shields.io/badge/%F0%9F%8E%93_D4_Teknik_Rekayasa_Komputer_Jaringan-PNLT-9B30FF?style=flat-square)
![Status](https://img.shields.io/badge/%F0%9F%9F%A2_Magang-BidTIK_Polda_Kalsel-6D28D9?style=flat-square)

![Visitor Count](https://komarev.com/ghpvc/?username=KuWeka&color=6D28D9&style=for-the-badge&label=PROFILE+VIEWS)
...
![FunFact](https://img.shields.io/badge/☕_Fun_Fact-More_Productive_At_Night-F59E0B?style=for-the-badge)
...
### 🛡️ HelpdeskPolda — Sistem IT Helpdesk Polda Kalsel ⭐ *Main Project*

<div align="center">

[![GitHub Repo](https://img.shields.io/badge/GitHub-Helpdesk--IT--POLDA-181717?style=for-the-badge&logo=github)](https://github.com/KuWeka/Helpdesk-IT-POLDA)
[![Version](https://img.shields.io/badge/version-1.0.0-9B30FF?style=for-the-badge)](#)
...
> 🏗️ Platform helpdesk IT berbasis **monorepo** untuk Polda Kalimantan Selatan — production-grade dengan real-time chat, multi-role dashboard, observability penuh, dan CI/CD pipeline siap pakai.

**✨ Fitur Unggulan:**

- 🎫 **Manajemen Tiket** — Buat, assign, tracking, dan riwayat tiket IT secara penuh dengan dashboard monitoring
- 💬 **Real-time Chat** — Komunikasi langsung antara user dan teknisi via Socket.IO
- 👥 **Multi-role Panel** — Dashboard terpisah untuk User, Teknisi, dan Admin
- 📊 **Dashboard & Insight** — Visualisasi statistik tiket, aktivitas, dan performa teknisi via Recharts
- 🔔 **Notifikasi Real-time** — Toast notification dan update status instan
- 🔐 **Enterprise Security** — JWT + Cookie auth, CSRF protection, rate limiting, Helmet.js
- 📈 **Observability** — Prometheus metrics, Winston logging, Grafana dashboard, health check endpoint
- 🐳 **Docker Ready** — Build & deploy siap container dengan staging scripts
- 🔄 **CI/CD Pipeline** — GitHub Actions: lint → build → image → staging deploy
- 📖 **API Docs** — Swagger UI terintegrasi

**Stack:** `React 18` `Vite 7` `Tailwind CSS` `shadcn/ui` `Radix UI` `Node.js 20` `Express` `MySQL 8` `Redis` `Socket.IO` `Docker` `JWT` `Prometheus` `Winston` `GitHub Actions` `Swagger`

---

### 🌱 Sistem Monitoring Tanaman Hidroponik Berbasis IoT
...
- 🌿 Pendataan lengkap siklus tanam dengan tracking per fase
- 📡 Integrasi sensor IoT untuk pemantauan kondisi tanaman secara real-time
- 🔔 Notifikasi otomatis pengingat siklus
- 📊 Visualisasi data pertumbuhan dan riwayat monitoring

**Stack:** `PHP` `CodeIgniter 4` `MySQL` `IoT Sensors` `MQTT`

---

### ⚙️ Aplikasi Pendataan Hidroponik (CodeIgniter 4)
...
- 📋 Pencatatan data pertumbuhan tanaman secara sistematis
- 🏗️ Arsitektur MVC yang terstruktur dan mudah dikembangkan
- 🔍 Pemantauan data pertumbuhan dengan laporan terorganisir
...
| 🔍 | Debug adalah seni — bukan masalah, tapi puzzle yang menunggu diselesaikan |
...
[![GitHub Streak](https://streak-stats.demolab.com?user=KuWeka&theme=tokyonight&border=6D28D9&ring=9B30FF&fire=C084FC&currStreakLabel=9B30FF&sideLabels=C084FC)](https://git.io/streak-stats)
...
[![Activity Graph](https://github-readme-activity-graph.vercel.app/graph?username=KuWeka&theme=tokyo-night&color=C084FC&line=9B30FF&point=ffffff&area=true&area_color=6D28D9)](https://github.com/ashutosh00710/github-readme-activity-graph)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:3b0764,40:6d28d9,80:9b30ff,100:c084fc&height=130&section=footer" width="100%"/>
